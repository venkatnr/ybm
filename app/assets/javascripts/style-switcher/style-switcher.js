...
jQuery(document).ready(function() {
	...
	jQuery('head').append('<script type="text/javascript" src="' + directory + '/assets/jquery.cookie.js">');
	...
	if(enable_style_switcher){
		...
		jQuery('head').append('<link type="text/css" rel="stylesheet" href="' + directory + '/assets/styler.css"/><script type="text/javascript" src="' + directory + '/assets/iris.min.js"></script>');
